...
class OrganizationProfileScreen extends ConsumerWidget {
      ...
      data: (p) => Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () => Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  EditOrganizationProfileScreen(profile: p),
            ),
          ),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    // TODO: swap for your real logo or Image.network(...)
                    CircleAvatar(
                      radius: 50,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _statRow(Icons.calendar_today, p.attendedEvents, 'Events'),
                      ...
                      Wrap(
                        spacing: 8,
                        children: p.skills
                            .map((domain) => SkillChip(label: domain))
                            .toList(),
                      ),
                    ],
                  ),
  ...
  Widget _statRow(IconData icon, int value, String label) {
    return Row(
      children: [
        Icon(icon, color: Color.fromRGBO(53, 151, 218, 1)),
